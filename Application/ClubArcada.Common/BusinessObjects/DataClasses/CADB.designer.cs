...
namespace ClubArcada.Common.BusinessObjects.DataClasses
{
    ...
    partial void InsertCashGame(CashGame instance);
    partial void UpdateCashGame(CashGame instance);
    partial void DeleteCashGame(CashGame instance);
    ...
    partial void DeleteUser(User instance);
		...
		public CADBDataContext() : 
				base(global::ClubArcada.Common.Properties.Settings.Default.ACDB_DEVConnectionString6, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<CashGameProtocolItem> CashGameProtocolItems
		{
			get
			{
				return this.GetTable<CashGameProtocolItem>();
			}
		}
		
		public System.Data.Linq.Table<CashGame> CashGames
		{
			get
			{
				return this.GetTable<CashGame>();
			}
		}
		...
		[global::System.Data.Linq.Mapping.FunctionAttribute(Name="dbo.sp_get_tournament_report")]
		public ISingleResult<sp_get_tournament_reportResult> sp_get_tournament_report([global::System.Data.Linq.Mapping.ParameterAttribute(DbType="DateTime")] System.Nullable<System.DateTime> dateFrom, [global::System.Data.Linq.Mapping.ParameterAttribute(DbType="DateTime")] System.Nullable<System.DateTime> dateTo)
		{
			IExecuteResult result = this.ExecuteMethodCall(this, ((MethodInfo)(MethodInfo.GetCurrentMethod())), dateFrom, dateTo);
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.WebContents")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CashGameProtocolItems")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CashGames")]
	public partial class CashGame : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnIsRunningChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CashGame_CashPlayer", Storage="_CashPlayers", ThisKey="Id", OtherKey="CashGameId")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CashGame_CashState", Storage="_CashStates", ThisKey="Id", OtherKey="CashGameId")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CashGame_CashTable", Storage="_CashTables", ThisKey="Id", OtherKey="CashGameId")]
	...
	public partial class CashIn : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<CashPlayer> _CashPlayer;
    ...
    partial void OnDateDeletedChanged();
		...
		public CashIn()
		{
			this._CashPlayer = default(EntityRef<CashPlayer>);
			OnCreated();
		}
		...
		public System.Guid PlayerId
		{
			...
			set
			{
				...
				{
					if (this._CashPlayer.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CashPlayer_CashIn", Storage="_CashPlayer", ThisKey="PlayerId", OtherKey="Id", IsForeignKey=true)]
		public CashPlayer CashPlayer
		{
			get
			{
				return this._CashPlayer.Entity;
			}
			set
			{
				CashPlayer previousValue = this._CashPlayer.Entity;
				if (((previousValue != value) 
							|| (this._CashPlayer.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._CashPlayer.Entity = null;
						previousValue.CashIns.Remove(this);
					}
					this._CashPlayer.Entity = value;
					if ((value != null))
					{
					...
					this.SendPropertyChanged("CashPlayer");
				}
			}
		}
    ...
    partial void OnDateDeletedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CashPlayer_CashOut", Storage="_CashPlayer", ThisKey="PlayerId", OtherKey="Id", IsForeignKey=true)]
		public CashPlayer CashPlayer
		{
			get
			{
	...
	public partial class CashPlayer : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<CashIn> _CashIns;
    ...
    partial void OnCreatedByUserIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CashPlayer_CashIn", Storage="_CashIns", ThisKey="Id", OtherKey="PlayerId")]
		public EntitySet<CashIn> CashIns
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CashPlayer_CashOut", Storage="_CashOuts", ThisKey="Id", OtherKey="PlayerId")]
		public EntitySet<CashOut> CashOuts
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CashGame_CashPlayer", Storage="_CashGame", ThisKey="CashGameId", OtherKey="Id", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._CashGame.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._CashGameId = value.Id;
					}
					else
					{
						this._CashGameId = default(System.Guid);
					}
		...
		private void attach_CashIns(CashIn entity)
		{
			this.SendPropertyChanging();
			entity.CashPlayer = this;
		}
		
		private void detach_CashIns(CashIn entity)
		{
			this.SendPropertyChanging();
			entity.CashPlayer = null;
		}
		
		private void attach_CashOuts(CashOut entity)
		{
			this.SendPropertyChanging();
			entity.CashPlayer = this;
		}
		
		private void detach_CashOuts(CashOut entity)
		{
			this.SendPropertyChanging();
			entity.CashPlayer = null;
		}
    ...
    partial void OnDateDeletedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CashGame_CashState", Storage="_CashGame", ThisKey="CashGameId", OtherKey="Id", IsForeignKey=true)]
		public CashGame CashGame
		{
			get
			{
    ...
    partial void OnCreatedByUserIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CashGame_CashTable", Storage="_CashGame", ThisKey="CashGameId", OtherKey="Id", IsForeignKey=true)]
		public CashGame CashGame
		{
			get
			{
    ...
    partial void OnDateCompletedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Request", Storage="_User", ThisKey="CreatedByUserId", OtherKey="Id", IsForeignKey=true)]
		public User User
		{
			get
			{
    ...
    partial void OnDateDeletedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Shift", Storage="_User", ThisKey="UserId", OtherKey="Id", IsForeignKey=true)]
		public User User
		{
			get
			{
    ...
    partial void OnCreatedByUserIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Structure_StructureDetail", Storage="_Structure", ThisKey="StructureId", OtherKey="Id", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Structure.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.StructureDetails.Remove(this);
					}
					this._Structure.Entity = value;
					if ((value != null))
					{
						value.StructureDetails.Add(this);
	...
	public partial class Structure : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<StructureDetail> _StructureDetails;
    ...
    partial void OnDateDeletedChanged();
		...
		public Structure()
		{
			this._StructureDetails = new EntitySet<StructureDetail>(new Action<StructureDetail>(this.attach_StructureDetails), new Action<StructureDetail>(this.detach_StructureDetails));
			OnCreated();
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Structure_StructureDetail", Storage="_StructureDetails", ThisKey="Id", OtherKey="StructureId")]
		public EntitySet<StructureDetail> StructureDetails
		{
			get
			{
			...
			set
			{
				this._StructureDetails.Assign(value);
			}
		}
		...
		private void attach_StructureDetails(StructureDetail entity)
		{
			this.SendPropertyChanging();
			entity.Structure = this;
		}
		
		private void detach_StructureDetails(StructureDetail entity)
		{
			this.SendPropertyChanging();
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TicketItems")]
    ...
    partial void OnDateDeletedChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Ticket_TicketItem", Storage="_Ticket", ThisKey="TicketId", OtherKey="Id", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._Ticket.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.TicketItems.Remove(this);
					}
					this._Ticket.Entity = value;
					if ((value != null))
					{
						value.TicketItems.Add(this);
	...
	public partial class Ticket : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<TicketItem> _TicketItems;
    ...
    partial void OnIdentificationChanged();
		...
		public Ticket()
		{
			this._TicketItems = new EntitySet<TicketItem>(new Action<TicketItem>(this.attach_TicketItems), new Action<TicketItem>(this.detach_TicketItems));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Ticket_TicketItem", Storage="_TicketItems", ThisKey="Id", OtherKey="TicketId")]
		public EntitySet<TicketItem> TicketItems
		{
			get
			{
				return this._TicketItems;
			}
			set
			{
				this._TicketItems.Assign(value);
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Tournament_Ticket", Storage="_Tournament", ThisKey="TournamentId", OtherKey="Id", IsForeignKey=true)]
		...
		private void attach_TicketItems(TicketItem entity)
		{
			this.SendPropertyChanging();
			entity.Ticket = this;
		}
		
		private void detach_TicketItems(TicketItem entity)
		{
			this.SendPropertyChanging();
			entity.Ticket = null;
		}
    ...
    partial void OnCreatedByUserIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_TournamentPlayer", Storage="_User", ThisKey="UserId", OtherKey="Id", IsForeignKey=true)]
		public User User
		{
			get
			{
	...
	public partial class Tournament : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<bool> _IsDocumentCreated;
    ...
    partial void OnReEntryCountChanged();
    partial void OnIsDocumentCreatedChanging(System.Nullable<bool> value);
    partial void OnIsDocumentCreatedChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IsDocumentCreated", DbType="Bit")]
		public System.Nullable<bool> IsDocumentCreated
		{
			get
			{
				return this._IsDocumentCreated;
			}
			set
			{
				if ((this._IsDocumentCreated != value))
				{
					this.OnIsDocumentCreatedChanging(value);
					this.SendPropertyChanging();
					this._IsDocumentCreated = value;
					this.SendPropertyChanged("IsDocumentCreated");
					this.OnIsDocumentCreatedChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Tournament_Ticket", Storage="_Tickets", ThisKey="Id", OtherKey="TournamentId")]
    ...
    partial void OnPCardIdChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Request", Storage="_Requests", ThisKey="Id", OtherKey="CreatedByUserId")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_Shift", Storage="_Shifts", ThisKey="Id", OtherKey="UserId")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="User_TournamentPlayer", Storage="_TournamentPlayers", ThisKey="Id", OtherKey="UserId")]
		public EntitySet<TournamentPlayer> TournamentPlayers
		{
			get
			{
	...
	public partial class sp_get_tournament_reportResult
	{
		...
		private System.Nullable<decimal> _League;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_League", DbType="Decimal(18,2)")]
		public System.Nullable<decimal> League
		{
			get
			{
				return this._League;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Dotation", DbType="Decimal(18,2)")]
		public System.Nullable<decimal> Dotation
		{
			get
			{
				return this._Dotation;
